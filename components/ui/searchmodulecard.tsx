...
export const SearchModuleCard: React.FC<SearchModuleCardProps> = ({ module }) => {
                    ...
                    >
                        ...
                        <div className="space-y-2">
                            ...
                            {module.prerequisites.length > 0 && (
                                <p><strong>Prerequisites:</strong> {module.prerequisiteNames.join(', ')}</p>
                            )}
                            ...
                            {module.additionalPrereqList && module.additionalPrereqList.length > 0 && (
                                <p><strong>Additional Prerequisites:</strong> {module.additionalPrereqList.join(', ')}</p>
                            )}
                        </div>
